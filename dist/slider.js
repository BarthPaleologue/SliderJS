export class Slider {
     ...
     */
    constructor(id, parent, min, max, initialValue, onSlide = (val) => {
        return;
    }) {
        this.min = min;
        this.max = max;
     ...
     * @param useCallback enable or disable callback execution
     */
    setValue(value, useCallback = true) {
